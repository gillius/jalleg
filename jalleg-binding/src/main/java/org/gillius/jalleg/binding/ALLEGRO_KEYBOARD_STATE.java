...
public class ALLEGRO_KEYBOARD_STATE extends Structure {
	...
	public int[] __key_down__internal__ = new int[((int)org.gillius.jalleg.binding.AllegroLibrary.ALLEGRO_KEY_MAX + 31) / 32];
	...
	public ALLEGRO_KEYBOARD_STATE(PointerByReference display, int __key_down__internal__[]) {
		super();
		this.display = display;
		if ((__key_down__internal__.length != this.__key_down__internal__.length)) 
			throw new IllegalArgumentException("Wrong array size !");
		this.__key_down__internal__ = __key_down__internal__;
	}
	public ALLEGRO_KEYBOARD_STATE(Pointer peer) {
		super(peer);
	}
