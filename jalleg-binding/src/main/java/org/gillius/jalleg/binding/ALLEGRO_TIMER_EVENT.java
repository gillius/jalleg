 ...
 */
public class ALLEGRO_TIMER_EVENT extends Structure {
	public int type;
	public PointerByReference source;
	public double timestamp;
	public long count;
	public double error;
	public ALLEGRO_TIMER_EVENT() {
		super();
	}
	protected List<? > getFieldOrder() {
		return Arrays.asList("type", "source", "timestamp", "count", "error");
	}
	public ALLEGRO_TIMER_EVENT(int type, PointerByReference source, double timestamp, long count, double error) {
		super();
		this.type = type;
		this.source = source;
	...
	public ALLEGRO_TIMER_EVENT(Pointer peer) {
		super(peer);
	}
